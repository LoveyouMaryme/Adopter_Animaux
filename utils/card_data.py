...
card_index_dict = card_index = [
    ...
    },
    {
        ...
        "text":  """
        Votre compagnon mérite un foyer aimant.
        Mettez-le en adoption dès aujour'hui
    ...
    },
    {
        ...
        "text":  """
        Rencontrez les humains au grand cœur
        qui veillent sur chaque compagnon.
        Découvrez notre mission, nos valeurs, et les visages
        de ceux qui rendent tout cela possible.""",
